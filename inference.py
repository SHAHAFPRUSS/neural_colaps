...
analysis_dataset = eval("datasets", conf["dataset"], "../data", "train=False, download=True, transform=transform")
...
try:
	model = eval("models",conf['model_conf']['model_name'], "pretrained=False, num_classes=", conf['C'])
